...
from crawl_utils.core.interfaces import Navigator, ResourceFetcher
from crawl_utils.core.models import NormalizedItem, SaveSummary
...
class CrawlPipeline:
    ...
    def __init__(
        ...
        *,
        ...
        self.saver = StorageDispatcher(policy.storage)
