...
This module exposes :class:`StructureOps`, a collection of static methods
for manipulating nested data structures such as lists, dictionaries and
key‑path representations.  These methods can normalize values to lists,
group flat lists into keyed dictionaries and flatten/unflatten nested
dictionaries.
"""
