with open(r"m:\CALife\CAShop - 구매대행\_code\modules\crawl_utils\presets\__init__.py", "w", encoding="utf-8") as f:
...
__all__ = [
    ...
    "DOMAIN_MAPPING", "METHOD_PATTERNS", "WEBDRIVER_OVERRIDES",
    "get_aliexpress_detail_preset", "get_aliexpress_search_preset",
]
''')

print("✅ __init__.py 재작성 완료!")
